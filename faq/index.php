...
<head>
    ...
    <title>FAQ | Farm Equipment Rentals</title>
</head>
    ...
    <section class="cd-faq">
        ...
        <div class="cd-faq-items">
            <ul id="basics" class="cd-faq-group">
                ...
                <li>
                    ...
                    <div class="cd-faq-content">
                        <p>Farm Equipment Rentalss gladly accepts Mastercard and Visa. Personal Checks are also accepted providing you purchase CDW and Theft Protection on your rental.
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">What if i find a better rate for a rental Tool?</a>
                    <div class="cd-faq-content">
                        <p>One of the many great things about Farm Equipment Rentals is our rental rates and services are guaranteed to be the very best in the industry. If you come across a lower price from a competitor and the rate is on a comparable tool including the same terms, locations, and rental tool fees we will be glad to beat the price for you. Please complete our Guaranteed Best Rate form if you have found a better rate with one of our competitors.</div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">Will i get a any service agent if rent a tool?</a>
                    <div class="cd-faq-content">
                        <p>Yes.Of Course!!! We will service agent details to communicate with you on your order.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>

                <li>
                    <a class="cd-faq-trigger" href="#0">Is there a fee if i return the tool after the due date?</a>
                    <div class="cd-faq-content">
            ...
            <ul id="membership" class="cd-faq-group">
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">What if i share my device?</a>
                    <div class="cd-faq-content">
                        <p>If you share your computer/mobile with others, you should log-out when you are done with your session on our web site. And, when you log-in, make sure that the check-box next to 'Save my password on this computer' is unchecked. Taking these steps will ensure that the next person using the computer will not have access to your account.</p>
                    </div>
                    <!-- cd-faq-content -->
                </li>
                <li>
            ...
            <ul id="chauffeur" class="cd-faq-group">
                ...
                <li>
                    <a class="cd-faq-trigger" href="#0">Is there a fee if i change my services?</a>
                    <div class="cd-faq-content">
                        <p>There is no fee to change reservations for services.
