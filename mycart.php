...
<?php $login_customer = $_SESSION['login_customer']; 
      $sql1 = "SELECT * FROM carttools rt, tools t
      WHERE rt.customer_username='$login_customer' AND t.tool_id=rt.tool_id ";
...
<div class="container">
      <div class="jumbotron">
        ...
        <p class="text-center"> Book tools to use now </p>
      </div>
    </div>
...
<td><a href="bookingconfirm.php?id=<?php echo $row["tool_id"];?>"> Rent Now </a></td>
</tr>
<?php        } ?>
                </table>
                </div> 
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">No  tools in cart!</h1>
        <p class="text-center"> Please add tools to cart  in order to view your data here. </p>
      </div>
    </div>
