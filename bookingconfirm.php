...
<?php
    ...
    if($err_date >= 0) { 
    $sql1 = "INSERT into rentedtools(customer_username,tool_id,tool_type,agent_id,booking_date,rent_start_date,rent_end_date,fare,charge_type,return_status) 
    VALUES('" . $customer_username . "','" . $tool_id . "','" . $tool_type . "','" . $agent_id . "','" . date("Y-m-d") ."','" . $rent_start_date ."','" . $rent_end_date . "','" . $fare . "','" . $charge_type . "','" . $return_status . "')";
    $result1 = $conn->query($sql1);

    $sql2 = "UPDATE tools SET tool_availability = 'no' WHERE tool_id = '$tool_id'";
    $result2 = $conn->query($sql2);

    $sql3 = "UPDATE agent SET agent_availability = 'no' WHERE agent_id = '$agent_id'";
    $result3 = $conn->query($sql3);

    $sql4 = "SELECT * FROM  tools t, clients cl, agent a, rentedtools rt WHERE t.tool_id = '$tool_id' AND a.agent_id = '$agent_id' AND cl.client_username = a.client_username";
