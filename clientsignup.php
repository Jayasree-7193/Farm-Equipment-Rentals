...
<head>
    <title> Admin Signup | Farm Equipment Rentals  </title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Farm Equipment Rentals - Registration</h1>
            <br>
        ...
        <div class="col-md-5 col-md-offset-4">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
				 ...
				 <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="client_surname"><span class="text-danger" style="margin-right: 5px;">*</span> Surname: </label>
                                <div class="input-group">
                                    <input class="form-control" id="client_surname" type="text" name="client_surname" placeholder="Surname" required="">
                                    <span class="input-group-btn">
                  <label class="btn btn-primary"><span class="glyphicon glyphicon-home" aria-hidden="true"></label>
              </span>
                                    </span>
