...
<?php $login_client = $_SESSION['login_client']; 
   ...
   { $sql1 = "SELECT * FROM rentedtools rt, clienttools ct, customers c, tools WHERE ct.client_username = '$login_client' AND ct.tool_id = rt.tool_id AND rt.return_status = 'R' AND c.customer_username = rt.customer_username AND ct.tool_id = tools.tool_id";
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1>No booked Tools</h1>
        <p> Rent some Tools now <?php echo $conn->error; ?> </p>
      </div>
    </div>
