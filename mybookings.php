...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT * FROM rentedtools rt, tools t
    WHERE rt.customer_username='$login_customer' AND t.tool_id=rt.tool_id AND rt.return_status='R'";
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">You have not rented any tools till now!</h1>
        <p class="text-center"> Please rent tools in order to view your data here. </p>
      </div>
    </div>
